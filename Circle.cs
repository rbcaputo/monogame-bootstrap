...
namespace MonoGame.Bootstrap
{
  ...
  public readonly struct Circle(int x, int y, int radius) : IEquatable<Circle>
  {
    ...
    /// </summary>
    /// <param name="left">The circle on the left hand side of the equality operator.</param>
    /// <param name="right">The circle on the right hand side of the equality operator.</param>
    ...
    /// </summary>
    /// <param name="left">The circle on the left hand side of the inequality operator.</param>
    /// <param name="right">The circle on the right hand side fo the inequality operator.</param>
