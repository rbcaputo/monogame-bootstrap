...
namespace MonoGame.Bootstrap.Scenes
{
  public abstract class Scene : IDisposable
  {
    ...
    public Scene()
    {
      ...
      {
        // Set the root directory for the content to the same as the root directory for the game's content.
    ...
    /// </summary>
    /// <remarks>
    /// When overriding this in a derived class, ensure that base.Iniitialize() still called
    /// as this is when LoadContent is called.
    /// </remarks>
    ...
    /// Dispose method. When Called from finalizer, this will be false.
    /// </param>
