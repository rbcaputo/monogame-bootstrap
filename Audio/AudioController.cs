...
namespace MonoGame.Bootstrap.Audio
{
  /// <summary>
  ...
  public class AudioController : IDisposable
  {
    ...
    // Tacks the volume for song playback when muting and unmuting.
    ...
    /// </summary>
    /// <remkarks>
    /// If IsMuted is true, the getter will always return back 0.0f and the setter will ignore setting the volume.
    /// </remkarks>
    ...
    /// <summary>
    /// Gets a value that indicates if this audio controller has been disposed of.
    /// </summary>
    ...
    public SoundEffectInstance PlaySoundEffect(
      SoundEffect soundEffect, float volume, float pitch,
    ...
    public void PlaySong(Song song, bool isRepeating = true)
    {
      ...
      // If we do not stop it, this could cause issues os some platforms.
