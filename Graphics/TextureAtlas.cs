...
namespace MonoGame.Bootstrap.Graphics
{
  public class TextureAtlas
  {
    ...
    public static TextureAtlas FromFile(ContentManager content, string fileName)
    {
      ...
      // </Regions>
      //
      // So we retrieve all of the <Region> elements then loop through each one and generate a new TextureRegion instance from it and add it to this atlas.
      ...
      // </Animations>
      //
      // So we retrieve all of the <Animation> elements then loop through each one and generate a new Animation instance from it and add it to this atlas.
