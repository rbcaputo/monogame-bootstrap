...
namespace MonoGame.Bootstrap.Graphics
{
  /// <summary>
    ...
    public static Tilemap FromFile(ContentManager content, string filename)
    {
      ...
      using (Stream stream = TitleContainer.OpenStream(filePath))
      {
        using (XmlReader reader = XmlReader.Create(stream))
        {
          ...
          // The <Tileset> element contains the information about the tileset used by the tilemap.
          //
          // Example:
          // <Tileset region="0 0 100 100" tileWidth="10" tileHeight="10">contentPath</Tileset>
          //
          // The region attribute represents the x, y, width, and height components of the boundary for the texture region within the texture at the contentPath specified.
          //
          // The tileWidth and tileHeight attributes specify the width and height of each tile in the tileset.
          //
          // The contentPath value is the contentPath to the texture to load that contains the tileset.
          ...
          // The <Tiles> element contains lines of strings where each line represents a row in the tilemap.
          // Each line is a space separated string where each element represents a column in that row.
          // The value of the column is the id of the tile in the tileset to draw for that location.
          //
          // Example:
          // <Tiles>
          //   00 01 01 02
          ...
          // Split the value of the tiles data into rows by splitting on the new line character.
